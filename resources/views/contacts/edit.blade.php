            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="container px-5 mx-auto" _msthidden="8">
                    ...
                    <div class="flex flex-wrap -m-2" _msthidden="6">
                        ...
                        <div class="p-2 w-full" _msthidden="1">
                        <button class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg" _msthash="1322126" _msttexthash="79859" _msthidden="1">更新する</button>
                        </div>
